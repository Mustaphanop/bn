...
import time 
elhypamody = '6140849049'
bot = telebot.TeleBot(Config.TG_BOT_TOKEN)
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "  mustapha 🔱",url="t.me/hn_pp")
...
في قائمة المطاية اصبح مطي جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == ".":
		f2 = message.from_user.first_name
		p3 = types.InlineKeyboardMarkup()
		p5 = types.InlineKeyboardButton(text = "🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱",url="t.me/hn_pp")
		p3.add(p5)
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/EU_UV")
		p3.add(e4)
		h = """[مطور السورس .](t.me/EU_UV)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://telegra.ph/file/57509bd3f685ba0dea69d.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/hn_pp")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/EU_UV")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس مصطفي
[قناة السورس .](t.me/hn_pp)
[مطور السورس .](t.me/EU_UV)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱",url="t.me/hn_pp")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @hn_pp*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱",url="t.me/hn_pp")
	p3.add(p5)
...
- @Sss0s0bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
		...
		bot.reply_to(message,"حصل ايه ؟؟")#جمع الاوامر 
...
- - - - - - - - - - - - - 
@YIIlbot*""",parse_mode="markdown",reply_markup=p3)
...
- - - - - - - - - - - - - -
@YIIlbot*""",reply_markup=p3,parse_mode="markdown")
  p3 = types.InlineKeyboardMarkup()
